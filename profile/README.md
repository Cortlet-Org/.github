...
## What We Build
We build developer tools, open-source/closed-source tools, etc
These are made with the Cortlet Philosiphy:
- Lightweight
- Secure-first
- No-bloat
- Problem-solving.
...
These open-source products follow the <a href="https://legal.cortlet.com/legal/code-of-conduct">Code of Conduct</a>.
